...
function update_character_controls( delta ){
	...
	if (moveForward && !InterdictionmoveForward){deplacement_normalize.z -= 1;}
	if (moveBackward && !InterdictionmoveBackward){deplacement_normalize.z += 1;}
	if (moveLeft && !InterdictionmoveLeft){deplacement_normalize.x -= 1;}
	if (moveRight && !InterdictionmoveRight){deplacement_normalize.x += 1;}
	if (jump && !Interdictionjump){deplacement_normalize.y += 1;}
